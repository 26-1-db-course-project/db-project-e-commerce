...
public class MemberValidator {
    ...
    // 주문 서비스: memberValidator.validateRole(memberId, MemberRole.ROLE_CUSTOMER)
    // 상품 등록 서비스: 상품 등록 서비스: memberValidator.validateRole(memberId, MemberRole.ROLE_BUSINESS)
    // 이런식으로 역할 제한하면 됨
